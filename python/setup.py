...
if(re.search(r'linux2',sys.platform)):
	setup(name="mathlink", version=pythonlinkversion,
		ext_modules=[
			Extension(
				"mathlink",
				["mathlink.c"],
				include_dirs = ["/usr/local/Wolfram/Mathematica/" + mathematicaversion + "/SystemFiles/Links/MathLink/DeveloperKit/Linux/CompilerAdditions"],
	...
	setup(name="mathlink", version=pythonlinkversion,
		ext_modules=[
			Extension(
				"mathlink",
				["/Volumes/Mathematica/Mathematica.app/SystemFiles/Links/Python/mathlink.c"],
				include_dirs = ["/Volumes/Mathematica/Mathematica.app/SystemFiles/Links/MathLink/DeveloperKit/CompilerAdditions"],
				library_dirs = ["/Volumes/Mathematica/Mathematica.app/SystemFiles/Links/MathLink/DeveloperKit/CompilerAdditions"],
				libraries = ["MLi3"],
			)
		]
	)
